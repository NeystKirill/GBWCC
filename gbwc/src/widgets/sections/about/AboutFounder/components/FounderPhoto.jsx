export default function FounderPhoto({ initials, photo, contactEmail, contactPhone }) {
  return (
    <div className="ab2-founder-photo-col">
      ...
      <div className="ab2-founder-contact">
        <div className="ab2-founder-contact-label">{contactEmail || 'info@gbwc.network'}</div>
        <div className="ab2-founder-contact-phone">{contactPhone || '+7 702 731 4400'}</div>
      </div>
    </div>
  )
}
