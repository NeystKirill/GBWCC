...
function AppStyles() {
  useEffect(() => {
    api.settings.get().then(data => {
      ...
      if (data.font_size_body) root.style.setProperty('--text-body', data.font_size_body)
      if (data.font_size_h2)   root.style.setProperty('--text-h2',   data.font_size_h2)
      if (data.font_size_h3)   root.style.setProperty('--text-h3',   data.font_size_h3)
