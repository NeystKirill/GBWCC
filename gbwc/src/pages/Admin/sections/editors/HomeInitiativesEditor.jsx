...
export default function HomeInitiativesEditor({ content, onSave }) {
    ...
    <div className="adm-form">
      <div className="adm-form-body">
        <div className="adm-section-info" style={{ marginBottom: 20 }}>
          Виджет «Инициативы» на главной — карточки инициатив GBWC.
        </div>
        ...
        <h3 style={{ margin: '24px 0 12px', fontSize: 15, color: 'var(--adm-navy)' }}>Инициативы</h3>
        <DynamicList
          items={form.items || []}
          onChange={v => set('items', v)}
          defaultItem={() => ({ tag: {}, title: {}, desc: {} })}
          renderItem={(item, onChange, idx) => (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div style={{ fontWeight: 600, fontSize: 12, color: 'var(--adm-gold)' }}>Инициатива {idx + 1}</div>
              <LangTabs label="Тег / Категория" value={item.tag || {}} onChange={v => onChange({ ...item, tag: v })} />
