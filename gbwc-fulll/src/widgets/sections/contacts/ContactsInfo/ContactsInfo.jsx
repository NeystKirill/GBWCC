...
export default function ContactsInfo({ d }) {
  return (
    <div className="ct3-info">
      <h2 className="ct3-info-title">{d.infoTitle}</h2>
      <p className="ct3-info-desc">{d.infoDesc}</p>

      {/* Address */}
      <div className="ct3-info-row">
        <span className="ct3-info-icon"><IconPin /></span>
        <div><p className="ct3-info-label">{d.addressLabel}</p><p className="ct3-info-val">{d.addressVal}</p></div>
      </div>
      ...
      <div className="ct3-info-row">
        ...
        <div>
          <p className="ct3-info-label">{d.socialLabel}</p>
