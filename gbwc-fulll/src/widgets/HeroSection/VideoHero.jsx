...
export default function VideoHero() {
  ...
  const [tit,  setTit]  = useState(slides[0].title)
        ...
        <section className="vh">
          ...
          <div className="vh-content">
            <div className={`vh-text${ts==='exit'?' exit':ts==='enter'?' enter':''}`}>
              <div className="vh-eyebrow">
                ...
                <span className="vh-etag">{slides[cur].tag}</span>
              </div>
              <h1 className="vh-hl">
                {slides[cur].lines.map((l,i)=>(
                  <span key={i} className="vh-line"><span className="vh-li">{l}</span></span>
                ))}
              </h1>
          ...
          <div className="vh-bar">
            <div className="vh-bar-left">
              ...
              <span className="vh-tit">{tit}</span>
            </div>
